...
const translations = {
  ...
  contact: {
    ...
    infoText: {
      en: "Whether you need a quick MVP, workflow automation, or AI integration — I'm ready to help. Use the form or open a chat with my Telegram bot.",
      ru: "Нужен быстрый MVP, автоматизация или интеграция AI? Заполните форму или напишите в Telegram-бота.",
    },
    ...
    telegram: {
      en: "Telegram bot @Alex_Assistant_freelancing_bot",
      ru: "Telegram-бот @Alex_Assistant_freelancing_bot",
    },
    telegramUsername: "Alex_Assistant_freelancing_bot",
    telegramButton: { en: "Message the bot", ru: "Написать боту" },
    telegramOpenAppHint: {
      en: "Opens Telegram app — no t.me in the browser (works when t.me is blocked).",
      ru: "Откроется приложение Telegram, без загрузки сайта t.me (если t.me не открывается).",
    },
    quickConnectLabel: { en: "Quick contact", ru: "Быстрый контакт" },
